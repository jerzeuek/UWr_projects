...
app.post('/2fa-on', async (req, res) => {
    ...
    if (verified) {
        ...
        res.render('2fa-on', {qr: res.cookie.data_url, totpsecret: res.cookie.totpsecret})
    }
});
...
const GOOGLE_CLIENT_ID = 'XXXXXXXXXXXXX';
const GOOGLE_CLIENT_SECRET = 'XXXXXXX';
