# Aby heurystyka stała się niedopuszczalna to jak na wykładzie do heurystyki domnażam (1 + epsilon)
# Zmiana w linijce 142
...
def priority(state):
    ...
    return len(state[5]) + (max(distances)*(1+epsilon))
