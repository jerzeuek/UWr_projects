# Program tworzący program w SWI-Prologu rozwiązujący burze
# Mamy 3 główne więzy:
    # Jeśli dwa pola na rogach są zamalowane, to musimy zrobić cały kwadrat (w burzach musza być prostokąty)
    # Jeśli jest jakieś pojedyncze zamalowane pole w rzędzie, to obok niego w poziomie musi być jeszcze minimum jedno zamalowane pole (bo minimalna burza ma rozmiar 2x2)
    # To samo ale w pionie
