    ...
    [(ifE b l r)
     (type-case Value (eval b)
       ...
       [else
        (error 'eval "type error")])]
    [(condE cs)
     (error 'eval "odcukrzenie failed")]))

;; odcukrzanie wyrażeń cond ------------------

(define (odcukrzanie [e : Exp]) : Exp
    (type-case Exp e
    [(numE n) (numE n)]
    [(opE o l r) (opE o (odcukrzanie l) (odcukrzanie r))]
    [(ifE b l r) (ifE (odcukrzanie b) (odcukrzanie l) (odcukrzanie r))]
    [(condE cs) (cond->if cs)]))
